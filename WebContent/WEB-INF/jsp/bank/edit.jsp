		...
		<div class="row">
			<div class="col-md-12">
				...
				<c var="objItem" items="${objItem}">
					<form action="${pageContext.request.contextPath}/bank/edit"
								...
								<div class="col-md-6 col-xs-12">
									<div class="input-group">
										<span class="input-group-addon"><span
											...
											name="name" class="form-control" value="${objItem.username }"/>
									</div>
								...
								<div class="col-md-6 col-xs-12">
									<div class="input-group">
										<span class="input-group-addon"><span
											...
											name="link" class="form-control" value="${objItem.username }"/>
									</div>
									<span class="help-block">This is sample of text field</span>
								</div>
							</div>
