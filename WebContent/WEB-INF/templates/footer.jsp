...
<div class="row footer" id="footer">
	...
	<div class="col-md-6">
		...
		<table class="tbl">
			<tr>
				<td style="width: 30%" class="color_cyan">Thảo</td>
				<td>kevin@gmail.com</td>
			</tr>
			<tr>
				<td class="color_cyan">Quốc</td>
				<td>martin@gmail.com</td>
			</tr>
			<tr>
				<td class="color_cyan">Đạt</td>
	...
	<div class="col-md-6">
		...
		<h5>
			Address: <span>Kiệt 82 Nguyễn Lương Bằng, Đà Nẵng , Việt Nam</span>
		</h5>
		<h5>
			Phone: <span>+84 (945) 15 1000</span>
		</h5>
		<h5>
			Skype: <span>BaQuaChuoi.Danang.XO</span>
		</h5>
		<h5>
			Website: <span>www.BaQuaChuoi.com</span>
		</h5>
	</div>
